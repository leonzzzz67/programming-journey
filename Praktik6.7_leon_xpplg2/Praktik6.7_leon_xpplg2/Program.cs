...
namespace Praktik6._7_leon_xpplg2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.Write("Masukkkan pilihan anda (1-3): ");
                ...
                switch (pilihan) 
                {
                 ...
                 break;
                 case 3:
                 Console.WriteLine("Anda memilih: Program akan berhenti...");
                 break; // Keluar dari switch
                 default:
                 Console.WriteLine("Pilihan di luar janngkauan. Harap masukkan 1, 2 atau 3.");
                 break;
                }
